...
// 2. Récupérer les événements de type "vedette"
$sql = "SELECT title, description, date_debut, date_fin, image FROM events WHERE type = 'vedette' ORDER BY date_debut ASC";
...
<head>
    ...
    <title>Événements Vedette</title>
    <link rel="stylesheet" href="eventstyle.css">
</head>
<body>

    <section class="events">
        <h1 class="heading">Événements Vedettes</h1>
        ...
        <?php else: ?>
            <p>Aucun événement vedette trouvé.</p>
        <?php endif; ?>
    </section>
